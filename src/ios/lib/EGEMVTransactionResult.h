...
#ifndef EGPaymentService_EGEMVTransactionResult_h
#define EGPaymentService_EGEMVTransactionResult_h

#import "EGTransactionResult.h"

/**
 * Represents the results of a successful EMV card transaction.
 */
@protocol EGEMVTransactionResult <EGTransactionResult>
...
/*
 * While read from the device, these don't seem to be passed to the Payment Service
